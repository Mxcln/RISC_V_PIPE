...
HD_PWD='C:/Users/Max/Desktop/RISC_V_PIPE/project/RISC_V_PIPE/RISC_V_PIPE.runs/one_cell_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log one_cell.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source one_cell.tcl
