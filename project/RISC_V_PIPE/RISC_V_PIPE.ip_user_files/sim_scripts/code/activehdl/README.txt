...
#
# Generated by export_simulation on Sat Jan 07 21:38:04 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './code.sh' script.
...
./code.sh -noclean_files

For more information on the script, please type './code.sh -help'.
